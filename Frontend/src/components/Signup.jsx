      ...
      <div className="w-[600px]">
        <div className="modal-box">
          ...
          <div className='mt-2 space-y-2'>
            <span>Password</span>
            <br />
            <input type="password" placeholder="Enter you password" className='w-80 px-2 py-1 border rounded-md outline-none' 
          ...
          <div className='flex justify-around mt-4'>
            ...
            <p className='text-xl'>Have an account? <button className='underline text-blue-500 cursor-pointer'
